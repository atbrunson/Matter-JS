 ...
 * @description Will allow scene view control with the mouse
 * 
 * 
 */
...
const { Events, Bounds, Mouse, Vector, MouseConstraint, Composite, world } = require("../main");
...
Events.on(render, 'beforeRender', function () {
	...
	let deltaCentre = Vector.sub(mouse.absolute, viewportCentre), centreDist = Vector.magnitude(deltaCentre);
	...
	if (scrolling) {
		...
		let direction = Vector.normalise(deltaCentre), speed = Math.min(10, Math.pow(centreDist, 2) * 0.00001);
